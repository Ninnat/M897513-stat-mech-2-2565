...
||Th 1 Dec|Proof of weak WLOL (continued); statistical entropy and typical sequences; classical dynamics and the notion of microstates|||Claude Shannons' [A Mathematical Theory of Communication](https://people.math.harvard.edu/~ctm/home/text/others/shannon/entropy/entropy.pdf) <br> The fact that typical sequences hog all the probability allows one to compress data systematically in the large $N$ limit.
||W 7 Dec|
